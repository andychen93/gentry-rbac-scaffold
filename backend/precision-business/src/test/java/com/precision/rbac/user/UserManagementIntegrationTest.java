package com.precision.rbac.user;
...
class UserManagementIntegrationTest {
    ...
    private static final String DB_URL = System.getProperty(
            "precision.test.db.url", "jdbc:postgresql://localhost:5432/precision");
    private static final String DB_USER = System.getProperty("precision.test.db.user", "postgres");
    private static final String DB_PASS = System.getProperty("precision.test.db.password", "123456");
