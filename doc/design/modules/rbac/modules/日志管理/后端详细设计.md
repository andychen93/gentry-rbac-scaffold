...
| LOG-011 | 操作日志模块选项 | /api/v1/logs/operation/modules | GET | 是 | system:operlog:list |
...
| v1.2.0 | 2026-09-03 | 技术经理（AI辅助） | 新增 LOG-011 modules；列表 module 精确匹配；VO `moduleLabel` 由中文 key 翻译 | 对齐 i18n §4.8.1 | 待评审 |
