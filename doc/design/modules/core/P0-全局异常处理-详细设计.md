...
**包路径：** `com.gentry.core.exception.GlobalExceptionHandler`
...
**包路径：** `com.gentry.core.common.ErrorCode`
...
logging:
  level:
    com.gentry.core.exception.GlobalExceptionHandler: WARN
```
...
**测试类：** `com.gentry.core.exception.GlobalExceptionHandlerTest`
...
**测试类：** `com.gentry.core.exception.GlobalExceptionHandlerIntegrationTest`
