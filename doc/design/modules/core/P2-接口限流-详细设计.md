...
> **实现状态：✅ 已实现** — 代码位于 `precision-core/src/main/java/com/precision/core/web/`，覆盖 7 个单元测试 + 端到端验证。
...
**包路径**：`com.precision.core.web.RateLimit`
...
**包路径**：`com.precision.core.web.RateLimitKeyType`
...
**包路径**：`com.precision.core.web.RateLimitAspect`
...
示例：
- rate_limit:IP:192.168.1.100:com.precision.gateway.controller.AuthController.login
...
**包路径**：`com.precision.core.web.RateLimitKeyTypeResolver`
...
**包路径**：`com.precision.core.web.RateLimitConfig`
...
| 配置项 | 键 | 默认值 | 说明 |
|--------|-----|--------|------|
| 缓存最大容量 | `precision.rate-limit.cache-max-size` | `10000` | 最大限流 key 数量 |
| 全局开关 | `precision.rate-limit.enabled` | `true` | 是否启用限流功能 |
...
**测试类**：`com.precision.core.web.RateLimitAspectTest`
...
**测试类**：`com.precision.core.web.RateLimitKeyTypeResolverTest`
...
**测试类**：`com.precision.core.web.RateLimitAspectTest`（续）
...
**测试类**：`com.precision.core.web.RateLimitIntegrationTest`
