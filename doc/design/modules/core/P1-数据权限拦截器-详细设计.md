...
> **实现状态：✅ 已实现** — 代码位于 `gentry-core/src/main/java/com/gentry/core/data/`（切面 + SPI + 上下文），gentry-business 提供 RbacUserDataScopeResolver / RbacDeptChildrenProvider 实现；覆盖 7 个单元测试。
...
**包路径**：`com.gentry.core.data.DataScope`
...
**包路径**：`com.gentry.core.data.DataScopeAspect`
...
**包路径**：`com.gentry.core.data.DataScopeHandler`
...
**包路径**：`com.gentry.core.data.DeptTreeCache`
...
**测试类**：`com.gentry.core.data.DataScopeHandlerTest`
...
**测试类**：`com.gentry.core.data.DeptTreeCacheTest`
...
**测试类**：`com.gentry.core.data.DataScopeHandlerTest`（续）
...
**测试类**：`com.gentry.core.data.DataScopeIntegrationTest`
