...
**包路径：** `com.gentry.core.interceptor.AutoFillHandler`
...
**包路径：** `com.gentry.core.entity.BaseEntity`
...
**包路径：** `com.gentry.core.entity.TenantEntity`
...
**包路径：** `com.gentry.core.config.AutoFillConfig`
...
**测试类：** `com.gentry.core.interceptor.AutoFillHandlerTest`
...
**测试类：** `com.gentry.core.interceptor.AutoFillIntegrationTest`
