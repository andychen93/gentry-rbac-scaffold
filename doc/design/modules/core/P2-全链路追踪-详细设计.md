...
> **实现状态：✅ 已实现** — 代码位于 `gentry-core/src/main/java/com/gentry/core/trace/`，覆盖 8 个单元测试 + 端到端验证。
...
**包路径**：`com.gentry.core.trace.TraceIdFilter`
...
**包路径**：`com.gentry.core.trace.TraceIdFilterConfig`
...
**包路径**：`com.gentry.core.trace.TraceContext`
...
**包路径**：`com.gentry.core.trace.TraceRunnable`
...
**包路径**：`com.gentry.core.trace.TraceCallable`
...
**包路径**：`com.gentry.core.trace.TraceUtils`
...
**说明**：`<optional>true</optional>` 表示此依赖不会传递给依赖 gentry-core 的模块。运行时如果存在 SkyWalking agent，则使用 SkyWalking traceId；否则降级为 UUID。
...
**测试类**：`com.gentry.core.trace.TraceIdFilterTest`
...
**测试类**：`com.gentry.core.trace.TraceContextTest`
...
**测试类**：`com.gentry.core.trace.TraceRunnableTest`
...
**测试类**：`com.gentry.core.trace.TraceCallableTest`
...
**测试类**：`com.gentry.core.trace.TraceUtilsTest`
...
**测试类**：`com.gentry.core.trace.TraceIdIntegrationTest`
